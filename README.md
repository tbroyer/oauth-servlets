...
You should also add dependencies on [`com.nimbusds:oauth2-oidc-sdk`](https://central.sonatype.com/artifact/com.nimbusds/oauth2-oidc-sdk) and [`com.nimbusds:nimbus-jose-jwt`](https://central.sonatype.com/artifact/com.nimbusds/nimbus-jose-jwt) so you can keep them up-to-date independently of OAuth-Servlets.
